    ...
    <div class="split-card gsap-reveal">
        ...
        <div class="form-side">
            ...
            <?php if (!empty($_SESSION['flash'])): ?>
                <div
                    class="bg-accent text-[#111] p-4 mb-8 border-2 border-black font-black uppercase text-[10px] tracking-widest gsap-item shadow-[4px_4px_0_black]">
                    <div class="flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
            ...
            <form method="post" action="<?= BASE_URL ?>/index.php?url=auth/login" class="gsap-item">
                ...
                <div class="mt-12 text-center">
                    <p class="text-[11px] font-bold text-gray-500 uppercase tracking-widest">
                        New Here? <a href="<?= BASE_URL ?>/auth/register"
