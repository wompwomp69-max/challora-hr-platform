...
<div class="split-card register-wide gsap-reveal">
    ...
    <div class="form-side">
        ...
        <form method="post" action="<?php echo e(route('register')); ?>" class="gsap-item">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6">
                <div class="mb-2">
                    ...
                    <input type="text" name="name" placeholder="John Doe" required
                        value="<?php echo e(old('name')); ?>" class="premium-input">
                </div>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="phone" placeholder="0812...." value="<?php echo e(old('phone')); ?>"
                        class="premium-input">
                </div>
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="email" name="email" placeholder="example@gmail.com" required
                    value="<?php echo e(old('email')); ?>" class="premium-input">
            </div>
            ...
            <div class="mt-12 text-center">
                <p class="text-[11px] font-bold text-gray-500 uppercase tracking-widest">
                    Already Has An Account? <a href="<?php echo e(route('login')); ?>"
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\challora-hr-platform-4.2.2\resources\views/auth/register.blade.php ENDPATH**/ ?>