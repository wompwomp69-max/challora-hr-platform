                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex gap-2">
                                <?php if($a->cv_path): ?>
                                    <a href="<?php echo e(route('view.document', ['type' => 'cv', 'id' => $a->id])); ?>" class="premium-btn-icon" title="CV">
                                        <i class="bi bi-file-earmark-person"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if($a->diploma_path): ?>
                                    <a href="<?php echo e(route('view.document', ['type' => 'diploma', 'id' => $a->id])); ?>" class="premium-btn-icon" title="Ijazah">
                                        <i class="bi bi-mortarboard"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if($a->photo_path): ?>
                                    <a href="<?php echo e(route('view.document', ['type' => 'photo', 'id' => $a->id])); ?>" class="premium-btn-icon" title="Pas Foto">
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?php echo e(route('hr.intelligence.candidates.show', $a->id)); ?>" class="action-select-premium bg-accent text-white no-underline text-center">View Profile</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\challora-hr-platform-4.2.2\resources\views/hr/applications/index.blade.php ENDPATH**/ ?>