        ...
        <div class="profile-grid">
            <div class="profile-main">
                ...
                <section class="info-card">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $user->organizationalExperiences ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $org): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="experience-item">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="text-xl font-black uppercase"><?php echo e($org->organization_name); ?></h3>
                                    <p class="text-accent font-bold"><?php echo e($org->position); ?></p>
                                </div>
                                <span class="bg-black text-white px-3 py-1 text-xs font-black">
                                    <?php echo e($org->start_year); ?> — <?php echo e($org->year_end); ?>

                                </span>
                            </div>
                            <p class="mt-4 text-text-muted font-medium"><?php echo e($org->description); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <section class="info-card" id="ai-optimization-section">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <form action="<?php echo e(route('user.settings.ai_suggestion')); ?>" method="POST" class="flex items-center gap-2" id="ai-gen-form">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="bg-secondary/30 p-6 border-l-4 border-yellow-500">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $suggestions['improvement_priority'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="bg-white border-2 border-black px-3 py-1 text-[10px] font-black uppercase"><?php echo e($item); ?></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            </div>
                        <?php elseif($latestSuggestion && $latestSuggestion->status === 'processing'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\challora-hr-platform-4.2.2\resources\views/user/settings/index.blade.php ENDPATH**/ ?>