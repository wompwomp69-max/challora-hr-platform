                        ...
                        <div class="brutalist-card p-6 flex flex-col gap-6 group">
                            <div class="flex justify-between items-start">
                                <div
                                    ...
                                    <?php echo e(strtoupper(substr($job->creator->name ?? 'TC', 0, 2))); ?>
                                ...
                                ?>
                                <span class="<?php echo e($color); ?> px-3 py-1 font-black text-[10px] uppercase border-2 border-black">
                            ...
                            <div>
                                ...
                                <p class="text-text-muted font-bold text-sm"><?php echo e($job->creator->name ?? 'Anonymous'); ?> ·
                            ...
                            <div class="flex flex-wrap gap-2 mt-auto">
                                <?php if($job->skills_json): ?>
                                    <?php $__currentLoopData = array_slice($job->skills_json, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span
                                            class="text-[10px] font-mono border border-black px-2 py-0.5"><?php echo e(strtoupper($skill)); ?></span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\challora-hr-platform-4.1.17\resources\views/landing.blade.php ENDPATH**/ ?>