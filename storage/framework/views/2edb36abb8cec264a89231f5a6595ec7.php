        ...
        <div class="filter-bar-premium">
            ...
            <div class="filter-group relative">
                <button type="button" 
                    ...
                    class="flex gap-2 items-center <?php echo e(request('top_choice') === '1' ? 'bg-accent text-white' : 'bg-white text-black'); ?> px-8 py-4 font-black uppercase tracking-widest border-4 border-black shadow-[6px_6px_0_0_black] hover:translate-y-[2px] transition-all group">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                    Top Choice
                </button>
                <input type="hidden" name="top_choice" id="top-choice-input" value="<?php echo e(request('top_choice', '0')); ?>">
            </div>
        </div>
    </form>
                ...
                <div class="job-card-premium" onclick="window.location.href='<?php echo e(route('jobs.show', $j->id)); ?>'">
                    ...
                    <div class="text-right flex flex-col items-end gap-3 relative z-10">
                        ...
                        <form method="post"
                            ...
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="save-btn <?php echo e($isSaved ? 'text-accent' : 'text-text-muted hover:text-accent'); ?> transition-all hover:scale-110">
                                <?php if($isSaved): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\challora-hr-platform-4.2.2\resources\views/user/jobs/index.blade.php ENDPATH**/ ?>