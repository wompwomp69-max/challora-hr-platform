...
<div class="flex flex-col w-full">
    ...
    <section class="s5-hero">
        ...
        <div class="s5-hero-left">
            <div class="s5-hero-image"><img src="<?php echo e(asset('hero.jpg')); ?>" alt="Hero" style="width:100%;height:100%;object-fit:cover;object-position:center;filter:grayscale(100%) contrast(1.2) brightness(0.8);"></div>
        ...
        <div class="s5-hero-right">
            <div class="s5-hero-right-top">
                ...
                <div class="flex gap-4">
                    <a href="<?php echo e(route('jobs.index')); ?>" class="s5-pill-btn s5-pill-primary">
                        Find Jobs
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="s5-pill-btn s5-pill-white">
                        Post a Job
                    </a>
                </div>
            </div>
            ...
            <div class="s5-system-status">
                ...
                <div class="s5-mono s5-status-grid">
                    ...
                    <div class="s5-status-item">
                        <span><?php echo e($s[0]); ?>. <?php echo e($s[1]); ?></span>
    ...
    <section class="s5-section">
        ...
        <div class="s5-grid-4">
            <div class="s5-grid-card group">
                ...
                <div class="mt-auto">
                    <a href="<?php echo e(route('register')); ?>" class="s5-mono text-[10px] text-accent font-bold border border-accent rounded-full px-4 py-2 group-hover:bg-accent group-hover:text-black transition-colors">EXPLORE</a>
                </div>
            </div>
            ...
            <div class="s5-grid-card group">
                ...
                <div class="mt-auto">
                    <a href="<?php echo e(route('jobs.index')); ?>" class="s5-mono text-[10px] text-accent font-bold border border-accent rounded-full px-4 py-2 group-hover:bg-accent group-hover:text-black transition-colors">EXPLORE</a>
                </div>
            </div>
    ...
    <section class="s5-section pt-0">
        <div class="flex justify-between items-end mb-8 border-b border-accent pb-4">
            ...
            <a href="<?php echo e(route('jobs.index')); ?>" class="s5-pill-btn text-accent border border-accent hover:bg-accent hover:text-black text-sm py-2 px-6">View All</a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border-t border-l border-accent">
            ...
            <div class="border-r border-b border-accent p-8 relative group hover:bg-[rgba(255,77,48,0.1)] transition-colors flex flex-col">
                <div class="s5-mono text-[10px] text-accent font-bold mb-4">OPEN // <?php echo e(strtoupper($job->location)); ?></div>
                <h3 class="s5-title-section text-2xl mb-4 leading-tight text-white group-hover:text-accent transition-colors"><?php echo e($job->title); ?></h3>
                <div class="flex flex-wrap gap-2 mb-8">
                    <?php if($job->skills_json): ?>
                        <?php $__currentLoopData = array_slice($job->skills_json, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="border border-accent text-accent px-3 py-1 s5-mono text-[9px]"><?php echo e($skill); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </div>
                <div class="mt-auto">
                    <a href="<?php echo e(route('jobs.show', $job->id)); ?>" class="s5-mono text-[10px] font-bold border border-accent bg-transparent text-accent rounded-full px-6 py-3 hover:bg-accent hover:text-black transition-colors">APPLY NOW</a>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\challora-hr-platform-4.2.2\resources\views/landing.blade.php ENDPATH**/ ?>