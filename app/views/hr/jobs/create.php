...
?>
<style>
/* ── Job Form Create — design-tokens.css ────────────────── */
...
.jf-title { font-size: 22px; font-weight: 700; color: var(--color-text); letter-spacing: -0.4px; margin-bottom: 24px; }
...
<div class="jf-wrap">
    ...
    <div class="jf-title">Post a New Job</div>
    ...
    <form method="post" action="<?= BASE_URL ?>/hr/jobs/create">
        ...
        <div class="jf-section">
            ...
            <div class="jf-field">
                <label class="jf-label" for="title">Job Title <span class="req">*</span></label>
                <input type="text" class="jf-input" id="title" name="title" required value="<?= e($old['title']) ?>" placeholder="e.g. Software Engineer, Digital Marketing Manager">
            </div>
            <div class="jf-field">
                ...
                <span class="jf-helper">Shown on the job card. Leave blank to use a snippet of the full description (max 255 chars).</span>
            </div>
            <div class="jf-field">
                <label class="jf-label" for="description">Full Description <span class="req">*</span></label>
                <textarea class="jf-textarea" id="description" name="description" rows="7" required><?= e($old['description']) ?></textarea>
            </div>
        </div>
        ...
        <div class="jf-section">
            ...
            <div class="jf-row-3" style="margin-bottom:14px">
                <div class="jf-field" style="margin-bottom:0"><label class="jf-label" for="provinsi">Province</label><input type="text" class="jf-input" id="provinsi" name="provinsi" placeholder="e.g. West Java" value="<?= e($old['provinsi']) ?>"></div>
                <div class="jf-field" style="margin-bottom:0"><label class="jf-label" for="kota">City / Regency</label><input type="text" class="jf-input" id="kota" name="kota" placeholder="e.g. Bandung" value="<?= e($old['kota']) ?>"></div>
                <div class="jf-field" style="margin-bottom:0"><label class="jf-label" for="kecamatan">District</label><input type="text" class="jf-input" id="kecamatan" name="kecamatan" placeholder="Optional" value="<?= e($old['kecamatan']) ?>"></div>
            </div>
            <div class="jf-field"><label class="jf-label" for="location">Street Address</label><input type="text" class="jf-input" id="location" name="location" placeholder="e.g. Jl. Asia Afrika No. 10" value="<?= e($old['location']) ?>"></div>
        </div>

        <div class="jf-section">
            <div class="jf-section-title">Salary & Applicant Cap</div>
            <div class="jf-row" style="margin-bottom:14px">
                <div class="jf-field" style="margin-bottom:0"><label class="jf-label" for="salary_range">Salary Range (text)</label><input type="text" class="jf-input" id="salary_range" name="salary_range" placeholder="e.g. 5–8 million" value="<?= e($old['salary_range']) ?>"></div>
                <div class="jf-field" style="margin-bottom:0"><label class="jf-label" for="max_applicants">Applicant Cap</label><input type="number" class="jf-input" id="max_applicants" name="max_applicants" min="1" placeholder="Leave blank for unlimited" value="<?= e($old['max_applicants']) ?>"></div>
            </div>
            <div class="jf-row">
                <div class="jf-field" style="margin-bottom:0"><label class="jf-label" for="min_salary">Min Salary (million)</label><input type="number" class="jf-input" id="min_salary" name="min_salary" placeholder="5" min="0" step="1" value="<?= e($old['min_salary']) ?>"></div>
                <div class="jf-field" style="margin-bottom:0"><label class="jf-label" for="max_salary">Max Salary (million)</label><input type="number" class="jf-input" id="max_salary" name="max_salary" placeholder="10" min="0" step="1" value="<?= e($old['max_salary']) ?>"></div>
            </div>
        </div>
