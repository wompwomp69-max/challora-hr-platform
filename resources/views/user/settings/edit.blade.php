...
<<<<<<< HEAD
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                @if($user->$field)
                                    <a href="{{ route('preview.user_file', ['type' => $key]) }}"
                                        class="btn-submit py-2 px-4 text-[10px] block text-center">LIHAT</a>
                                @else
                                    <span class="btn-submit py-2 px-4 text-[10px] block text-center opacity-40 cursor-not-allowed">LIHAT</span>
                                @endif
                                <label for="file-{{ $key }}"
...
<<<<<<< HEAD
    ...
    <script>
        // --- ADD NEW buttons: attach immediately, no GSAP dependency ---
        ...
        // --- GSAP animations: wait until GSAP is ready ---
        (function runEditAnim() {
            if (!window.gsap) return setTimeout(runEditAnim, 50);
