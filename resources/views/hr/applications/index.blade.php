...
<<<<<<< HEAD
                                ...
                                @endif
                                @if($a->user->photo_path)
                                    <a href="{{ route('download.file', ['type' => 'photo', 'id' => $a->id, 'back' => url()->current()]) }}" class="premium-btn-icon" title="Foto Formal">
                        ...
                        <td class="text-right">
                            ...
                            <a href="{{ route('hr.applications.berkas', $a->id) }}" class="action-select-premium" style="text-decoration:none;">
                                View Biodata
                            </a>
